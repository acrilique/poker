...
// CACHE_VERSION is stamped at build time by the server (see build.rs): the
// short git SHA in dev, a build timestamp in the Docker path. No manual bump.
var CACHE_VERSION = "__POKER_CACHE_VERSION__";
